...
public class AuthenticatedFlightCrewMemberUpdateService extends AbstractGuiService<Authenticated, FlightCrewMember> {
	...
	public void load() {
		...
		FlightCrewMember member = this.repository.findFlightCrewMemberByUserAccountId(id);
	...
	public void bind(final FlightCrewMember flightCrewMember) {
		super.bindObject(flightCrewMember, "phoneNumber", "languageSkills", "flightCrewMemberStatus");
	}
	...
	public void unbind(final FlightCrewMember flightCrewMember) {
		...
		SelectChoices statusChoices = SelectChoices.from(FlightCrewMemberStatus.class, flightCrewMember.getFlightCrewMemberStatus());
