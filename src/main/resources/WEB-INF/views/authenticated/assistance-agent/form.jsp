...
<acme:form>
	...
	<acme:input-moment code="authenticated.assistance-agent.form.label.startWorking" path="startWorking" readonly="true"/>
	...
	<acme:input-textbox code="authenticated.assistance-agent.form.label.photoLink" path="photoLink"/>
